    ...
    <div class="flex justify-between items-center h-16">
      ...
      <div class="flex items-center space-x-6">
        ...
        <a href="#" class="text-gray-600 hover:text-red-600 relative">
          ...
          <span class="absolute -top-1 -right-2 bg-red-500 text-white text-xs px-2 rounded-full">2</span>
        </a>
        ...
        <div class="relative inline-block text-left">
          ...
          <div id="dropdownMenu" class="hidden absolute right-0 mt-2 w-56 bg-white border rounded-md shadow-lg z-10">
            ...
            <a href="dashboard.jsp" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
...
<script>
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const suggestions = document.querySelectorAll("#searchSuggestions span");
