...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
    ...
    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden border border-gray-100">
      ...
      <div class="p-4">
        <!-- Product name -->
        <h3 class="font-semibold text-lg mb-1"><%= product.get("name") %></h3>
                
        <!-- Prices -->
        <div class="flex items-center justify-between mb-3">
          <span class="text-lg font-bold text-blue-600">$<%= product.get("price") %></span>
          <span class="text-sm text-gray-400 line-through">$<%= product.get("oldPrice") %></span>
        </div>
